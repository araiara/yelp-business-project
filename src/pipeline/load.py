...
def load_into_dwh(connection):
    ...
    try:
        ...
        for file_name in sorted(load_procedure_dir_files):
            # if file_name in ['load_i_dim_location.sql', 'load_ii_dim_business.sql', 'load_iii_dim_checkin.sql', 'load_iv_dim_user.sql', 'load_v_fact_business_review.sql', 'load_vi_fact_business_tip.sql']:
            #     continue
