...
BEGIN
  ...
  SELECT 
  BTRIM(CAST(user_temp_detail -> 'user_id' AS TEXT), '"'),
  BTRIM(CAST(user_temp_detail -> 'name' AS TEXT), '"'),
  user_temp_detail -> 'review_count',
  BTRIM(CAST(user_temp_detail -> 'yelping_since' AS TEXT), '"'),
  BTRIM(CAST(user_temp_detail -> 'friends' AS TEXT), '"'),
  user_temp_detail -> 'useful',
  user_temp_detail -> 'funny',
  user_temp_detail -> 'cool',
  user_temp_detail -> 'fans',
  BTRIM(CAST(user_temp_detail -> 'elite' AS TEXT), '"'),
